...
this.eventCallbacks[event].splice(i, 1);
```
Please also notice that our add method adds 1 element and our sub method subtracts 0 or 1 element for each call. It still correctly satisfies our balance definition, because an addition of an element has the potential of being subtracted, given an infinite amount of time.
